...
modularity
can be leveraged to perform more complicated analyses, for
example, incorporating
data from multiple marks.

# Install

We can install `r Githubpkg("selinj/chromswitch")` from GitHub
...
tissues and 3 other adult tissues from the Roadmap Epigenomics
Program,
