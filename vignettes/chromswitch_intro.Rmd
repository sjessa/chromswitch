...
restricted to a short region on chromosome 19. The data packged with
...
callPositionAware(query = regions,
                  peaks = H3K4me3,
                  metadata = metadata)
...
out <- callWholeRegion(query = query,
                peaks = pk_k4me3,
                metadata = meta,
                mark = "H3K4me3",
                normalize = TRUE,
...
not covered here by running `??chromswitch::callWholeRegion`.
```{r wr}

out2 <- callWholeRegion(# Standard arguments of the function
                query = query,
                peaks = pk_k4me3,
                metadata = meta,
                mark = "H3K4me3",
...
```{r pa_basic}
out3 <- callPositionAware(query = query,
                peaks = pk_k4me3,
                metadata = meta,
                reduce = TRUE,
                gap = 300,
